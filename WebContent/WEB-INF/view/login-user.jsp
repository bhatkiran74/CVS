        ...
        <section class="home">
            ...
            <form action="./userlist" >
                ...
                <div class="form_group">
                    ...
                    <input type="number" name="mobileNo" id="mobileNo" min="1" max="999999999" placeholder="Enter User Id"/>
                </div>

                <div class="form_group">
                    <label for="password">Password</label>
                    <input type="password"  name="password" id="password" placeholder="Enter password"/>
                    <a href="#" style="text-align: right;margin-top: 2px;">Forgot Password</a>
                </div>

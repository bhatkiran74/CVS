        ...
        <section class="home">
            ...
            <div class="register_form_container">
                ...
                <div class="form_group title">
                     <h3>Schedule Covid Vaccination</h3>
                    <p>Schedule Covid Vaccination Data Update Form</p>
                </div>
               <form:form action="schedulesaveuser" modelAttribute="user" method="POST" >
				...
				<form:hidden path="govtId"/>
				<form:hidden path="idNo"/>
				<form:hidden path="firstVaccineDate"/>
               ...
               <div class="form_group">
                    ...
                    <form:input  path="secondVaccineDate"/>
             </div>

                  <div class="form_group">
                    <label for="totalVaccine">Total Vaccine</label>
                    <form:input path="totalVaccine" Value="2"/>
                </div>

              <div class="form_group">
                    <label for="vaccinePlace">Vaccination Place</label>
                    <form:input path="vaccinePlace" />
                </div>

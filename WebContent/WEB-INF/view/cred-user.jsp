...
<head>
	...
	function  my() {
	  if (document.getElementById('password').value ==
	   ...
	   alert(' Password matched, Login and schedule Your first dose Vaccination');
	  } else {
		  alert('Password not matched,Try to register once agian');
	  }
	}
        ...
        <section class="home">
            ...
            <div class="register_form_container">
                ...
                <div class="form_group title">
                    <h3>Login Credentials Form</h3>
                    <p>Enter the Valid Password </p>
                </div>
               <form:form action="credentialsuser" modelAttribute="user" method="GET">
		
				<form:hidden path="userId"/>
              <div class="form_group">
                    <label for="mobileNo">Mobile No</label>
                    <form:input  path="mobileNo" Name="mobileNo"/>
                ...
                <div class="form_group">
                    <input type="submit" class="btn" value="Submit" onclick="my();">
                </div>
                 </form:form>
            </div>
